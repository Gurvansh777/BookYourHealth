...
public class ViewComplaintUser extends AppCompatActivity {
    DatabaseHelper dbh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_complaint_user);
        ...
        dbh = new DatabaseHelper(ViewComplaintUser.this);
        Cursor cComplaints = dbh.getComplaintsByUserId(loggedInUserId);
        if (cComplaints.getCount() > 0) {
            ...
            for (int i = 0; i < cComplaints.getCount(); i++) {
                ...
                String complaint = cComplaints.getString(4);
                complaint += "\n" + cComplaints.getString(5);
                //complaint += "\n" + cComplaints.getString(1);
                //complaint += "\n" + cComplaints.getString(3);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent,
                    ...
                    Intent intentToComplaintDetail = new Intent(ViewComplaintUser.this, ViewComplaintDetail.class);
            ...
            Toasty.warning(ViewComplaintUser.this, "There are no complaints yet!", Toast.LENGTH_LONG).show();
            finish();
        }
    }
}
